...
{   int choice;
    printf ("\n\n\n\n\t\t============================================\n\n");
    printf("\t\t\tDIU GIRLS HOSTEL MANAGEMENT SYSTEM");
...
system("CLS");
    switch(choice)
    {
        ...
        case 1:new_entry();   system("CLS");
        break;
        case 2:edit();    system("CLS");
        break;
        case 3:see();    system("CLS");
        break;
        case 4:sorter();    system("CLS");
        break;
        case 5:erase();    system("CLS");
        break;
        case 6:view_list();   system("CLS");
        break;
        case 7:closer();    system("CLS");
        break;
        default:menu();    system("CLS");
    }
}
